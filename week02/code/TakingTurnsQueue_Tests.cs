...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The PersonQueue class was implemented as a Stack (LIFO) instead of a Queue (FIFO).
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with 0 turns (infinite) were not being re-enqueued after their turn.
    ...
    // Defect(s) Found: People with negative turns (infinite) were not being re-enqueued after their turn.
